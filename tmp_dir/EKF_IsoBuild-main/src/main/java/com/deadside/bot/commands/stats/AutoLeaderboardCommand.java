...
public class AutoLeaderboardCommand implements ICommand {
    ...
    private void sendComprehensiveLeaderboard(TextChannel channel) {
        ...
        List<Player> topKillers = playerRepository.getTopPlayersByKills(5);
        List<Player> topKD = playerRepository.getTopPlayersByKD(3, 10);
        List<Player> topDeaths = playerRepository.getTopPlayersByDeaths(3);
        List<Player> topDistance = playerRepository.getTopPlayersByDistance(3);
        List<Player> topStreak = playerRepository.getTopPlayersByKillStreak(3);
